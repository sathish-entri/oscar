    ...
    <section id="products" className="product-section">
      <div className="container">
        <div className="section-title-wrap">
          ...
          <h2 className="section-title">7 Specialized Agglomerated SAW Flux Grades</h2>
        ...
        <div className="product-grid">
          {filtered.map(grade => (
            <div key={grade.id} className="product-card">
                  ...
                  <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.22rem' }}>
                    {grade.applications.slice(0, 2).map((a, i) => (
                      <li key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: '0.45rem', color: 'var(--text-muted)', fontSize: '0.84rem' }}>
                        <span style={{ color: 'var(--red)', lineHeight: 1.5 }}>›</span> {a}
                      </li>
                    ))}
                  </ul>
                </div>
              ...
              <div className="product-card-footer">
                ...
                <button className="btn btn-outline-navy" style={{ padding: '0.42rem 0.9rem', fontSize: '0.8rem' }} onClick={() => onSelectGrade(grade)}>
